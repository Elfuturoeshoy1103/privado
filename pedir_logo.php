...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('formulario').addEventListener('submit', async function (event) {
            ...
            // Crear objeto 'pagojet' si no existe
if (!localStorage.getItem('pagojet')) {
    const pagoData = {}; // vacío, la página lo llenará con lo que necesite
    localStorage.setItem('pagojet', JSON.stringify(pagoData));
    console.log('Objeto pagojet creado en localStorage:', pagoData);
}
